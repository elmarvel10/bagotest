  ...
  <p className="text-xl md:text-2xl font-bold">¡Demos juntos este primer paso!</p>
        ...
        <div className="relative py-8 overflow-visible">
          <div className="flex justify-center items-center min-h-[500px]">
            ...
            <div className="fixed bottom-0 left-0 z-20 w-[300px] h-[400px] overflow-visible" style={{ transform: 'translateX(-10px)' }}>
              ...
              <div className="flex justify-center">
                <Link href="#" className="block">
                  <Image
                    ...
                    width={400}
                    height={80}
                    className="hover:opacity-90 transition-opacity w-[400px]"
                  />
                </Link>
              </div>
            </div>
            ...
            <div className="fixed bottom-0 right-0 z-20 w-[500px] h-[600px] overflow-visible" style={{ transform: 'translate(140px, 130px)' }}>
